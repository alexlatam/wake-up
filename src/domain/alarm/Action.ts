...
export type PuzzleLevel = 'EASY' | 'MEDIUM' | 'MAXIMUM' | 'CUSTOM';
export type TypeTextLevel = 'EASY' | 'MEDIUM' | 'MAXIMUM' | 'CUSTOM';
export type ShakeLevel = 'EASY' | 'MEDIUM' | 'MAXIMUM' | 'EXTREME' | 'CUSTOM';
...
export type ActionConfig =
  ...
  | { type: 'PUZZLE'; position: number; level: PuzzleLevel; imageUri: string | null; customRows?: number; customCols?: number }
  | { type: 'TYPE_TEXT'; position: number; level: TypeTextLevel; customWordCount?: number }
  | { type: 'SHAKE'; position: number; level: ShakeLevel; customSeconds?: number }
